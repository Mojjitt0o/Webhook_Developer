...
//     // Mendengarkan event 'chatMessage' untuk pesan chat
//     socket.on('chatMessage', async (message) => {
//         console.log('Pesan chat diterima:', message);

//         // Kirim pesan chat ke Telegram
//         await sendTelegramMessage(`Pesan Chat: ${message}`);

//         // Emit pesan chat ke semua klien
...
// // Endpoint untuk menerima pesan balasan dari bot Telegram
...
//     // Emit pesan ke semua klien chat
//     io.emit('chatMessage', `Pemilik: ${text}`);

//     res.sendStatus(200);
// });

// // Set webhook untuk bot Telegram
// async function setTelegramWebhook() {
//     const url = `https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/setWebhook`;
//     const webhookUrl = 'https://yourdomain.com/webhook'; // Ganti dengan URL webhook Anda
//     try {
//         const response = await axios.post(url, {
//             url: webhookUrl
//         });
//         console.log('Webhook Telegram diset:', response.data);
//     } catch (error) {
//         console.error('Error mengatur webhook Telegram:', error.message);
//     }
// }

// // Panggil setTelegramWebhook saat server dimulai
// setTelegramWebhook();
...
//         // Emit pesan chat ke semua klien
//         io.emit('chatMessage', `Anda: ${message}`);
//     });
